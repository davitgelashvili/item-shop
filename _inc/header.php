        ...
        <div class="m-header d-block d-lg-none">
            <div class="container">
                <ul class="m-header__menu d-flex justify-content-between">
                    ...
                    <li class="m-header__menu--li">
                        <a href="?act=social-program" class="m-header__menu--a regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                    ...
                    <li class="m-header__menu--li">
                        <a href="?act=news" class="m-header__menu--a regular d-flex flex-column align-items-center">
                            <figure class="m-header__menu--figure d-flex justify-content-center">
                                <div class="m-header__menu--icon">
                                    ...
                                    <div class="profile open-active" data-active="profile-window">
                                        <div class="profile__head">
                                            ...
                                            <span class="profile__head--mail regular d-flex justify-content-between">
                                                <p>
                                                    datoogelashvili@gmail.com
                                                </p>
                                                <button class="profile__logout--btn regular">Log Out</button>
                                            </span>
                                        </div>
                                        <div class="profile__head d-flex">
                                            <button class="profile__head--signin bold btn click-open" data-active="login-popup">
                                                Sign in
                                            </button>
                                            <button class="profile__head--regis bold btn click-open" data-active="login-popup">
                                                Register
                                            </button>
                                        </div>
