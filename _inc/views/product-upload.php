                    ...
                    <div class="shop-detail__slider">
                        <div class="shop-detail__main-slider">
                            <label class="upload__image d-flex flex-column align-items-center justify-content-center">
                                ...
                                <input type="file" class="upload__image--input h-roman"
                                    onchange="fileUploadImage(this, value)">
                                <img src="" alt="" class="upload__image--uploaded">
                                <div class="upload__image--btn regular product-upload-upload-btn">Browse</div>
                            </label>
                        </div>
                        <div class="shop-detail__mini-slider upload__image--mini d-flex align-items-center">
                            <div
                                class="shop-detail__mini-slider--cover upload__image--upload d-flex align-items-center justify-content-center">
                                <label
                                    class="upload__image d-flex flex-column align-items-center justify-content-center">
                                    <img class="upload__image--icon product-upload-page-upload-img-icon" src="img/svg/upload-icon.svg" alt="">
                                    <input type="file" class="upload__image--input h-roman"
                                        onchange="fileUploadImage(this, value)">
                                    <img src="" alt="" class="upload__image--uploaded">
                                </label>
                                <div
                                    class="upload__image--btn-footer d-flex justify-content-between align-items-center">
                                    <input type="radio" value="1" class="radio-on-img">
                                    <button
                                        class="products-slider__item--fav upload__image--btn-delete buttons-on-image-upload"><img
                                            src="img/svg/trash.svg" class="trash-on-image-upload" alt=""></button>
                                </div>
                            </div>
                            <div
                                class="shop-detail__mini-slider--cover upload__image--upload d-flex align-items-center justify-content-center">
                                ...
                                <div class="upload">
                                    <div class="upload__body-mobile">
                                        <div class="upload__head--menu-mobile regular">
                                            <div class="upload-product-tab-mobile" data-tab="0"><span
                                                    class="tab-number">1</span> Listing Details</div>
                                            <div class="upload__body--tab-mobile" data-tab="0">
                                                <div class="col-12">
                                                    <div class="cart-order__form--label">
                                                        <span
                                                            class="cart-order__form--title product-upload-titles regular">
                                                ...
                                                <div class="col-12">
                                                    <div class="cart-order__form--label">
                                                        <span
                                                            class="cart-order__form--title regular product-upload-titles">
                                                            <img src="img/svg/red-union.svg" alt="">
                                                            Title Geo
                                                        </span>
                                                        <input type="text" class="cart-order__form--input regular"
                                                ...
                                                <div class="col-3 selects-inproduct-upload">
                                                    <div class="cart-order__form--label">
                                                        ...
                                                        <input type="date" class="cart-order__form--input regular"
                                                            placeholder="">
                                                    </div>
                                                </div>
                                                <div class="col-12" style="margin-top: 48px;">
                                                    <div class="cart-order__form--label">
                                                        ...
                                                        <div
                                                            class="dropdown-container product-upload-add-categories d-none">

                                                            <button type="button" class="regular prev-categories">
                                                                <img src="img/svg/header-btn/arrow.svg"
                                                                    class="color-blue" alt="">
                                                    ...
                                                    <div class="cart-order__form--label">
                                                        ...
                                                        <div class="product-upload__tags">
                                                            ...
                                                            <ul class="selected-tags">
                                                                <li>
                                                                    ...
                                                                    <img src="img/svg/popup-close.svg"
                                                                        class="remove-tag" alt="">
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="dropdown-container product-upload-add-tags">
                                                            <ul class="tags-list regular">
                                                                <li>
                                                                    <label
                                                                        class="element__check d-flex align-items-center">
                                                                        <div>
                                                                            <input type="checkbox"
                                                                                class="element__check--input">
                                        ...
                                        <div class="upload__head--menu-mobile regular current-mobile-tab">
                                            <div class="upload-product-tab-mobile active-tab-head" data-tab="0"><span
                                                    class="tab-number">2</span> Listing Details</div>
                                            <div class="upload__body--tab-mobile active-mobile-tab" data-tab="1">
                                                <div class="col-3" style="width: 197px">
                                                    <div class="cart-order__form--label">
                                                        ...
                                                        <select class="select__list regular selects-inproduct-upload"
                                                            name>
                                                ...
                                                <div class="col-3" style="width: 197px">
                                                    <div class="cart-order__form--label">
                                                        ...
                                                        <select class="select__list selects-inproduct-upload regular"
                                                            name>
                                                            <option value="new">New</option>
                                                            <option value="opt1">Opt1</option>
                                                            <option value="opt2">Opt2</option>
                                                ...
                                                <div class="cart-order__form--product-characteristics">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <button class="remove-charasteristic-btn">
                                                            <img src="img/svg/trash.svg" class="remove-charasteristic"
                                                                alt="trash" />
                                                        </button>
                                                    </div>
                                                    <div class="form-field">
                                                        <div class="cart-order__form--label">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <input type="text"
                                                                    class="cart-order__form--input regular selects-inproduct-upload"
                                                                    placeholder="">
                                                                <input type="checkbox" name="check" class="checkboxes"
                                                ...
                                                <div class="product-description-container">
                                                    <span class="product-description-title regular">Product Description
                                                        Eng</span>
                                                    <textarea name="productDescription"
                                                        class="product-description regular product-upload__descriptions"
                                                        rows="10"></textarea>
                                                </div>
                                                <div class="product-description-container">
                                                    <span class="product-description-title regular">Product Description
                                        ...
                                        <div class="upload__head--menu-mobile regular">
                                            <div class="upload-product-tab-mobile" data-tab="0"><span
                                                    class="tab-number">3</span> Listing Details</div>
                                            <div class="upload__body--tab-mobile tab-start" data-tab="2">
                                                ...
                                                <div
                                                    class="d-flex justify-content-between align-items-center default-values">
                                                ...
                                                <div class="row item-info-container">
                                                    <div class="col-md-4">
                                                        <label class="cart-order__form--label mt-0">
                                                            ...
                                                            <select
                                                                class="select__list selects-inproduct-upload regular item-info"
                                                                name style="width: 100%; height: 48px;">
                                                    ...
                                                    <div class="col-md-2">
                                                        <label class="contact-page__form--label mt-0">
                                                            ...
                                                            <input type="text"
                                                                class="contact-page__form--input item-info"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <label
                                                            class="contact-page__form--label mt-0 option-photo-container">
                                                            <p class="cart-order__form--title item-info-title regular">
                                                                Option Photo
                                                            </p>
                                                            <div class="option-photo-actions">
                                                                <input type="file" name="photo" id="upload-option-photo"
                                                                    class="d-none">
                                                                <label for="upload-option-photo"
                                                                    class="upload-option-photo">
                                                                    <img src="img/svg/upload-icon.svg"
                                                                        class="convert-svg" alt="upload" />
                                                                </label>
                                                                <button class="remove-option-photo-btn">
                                                                    <img src="img/svg/trash.svg"
                                                                        class="remove-option-photo" alt="trash" />
                                                                </button>
                                                            </div>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="upload__head--menu-mobile regular">
                                            <div class="upload-product-tab-mobile" data-tab="0"><span
                                                    class="tab-number">4</span> Listing Details</div>
                                                ...
                                                <div class="col-md-4">
                                                    <label class="contact-page__form--label">
                                                        ...
                                                        <div class="donate-to-options">
                                                            <div class="d-flex align-items-center">
                                                                <input type="radio" value="1" id="donate-to-charity"
                                                                    name="donate-to" class="radio-on-img">
                                                                <label for="donate-to-charity"
                                                                    class="regular donate-to-label">Charity</label>
                                                            </div>
                                                            <div class="d-flex align-items-center">
                                                                <input type="radio" value="1"
                                                                    id="donate-to-social-program" name="donate-to"
                                                                    class="radio-on-img">
                                                                <label for="donate-to-social-program"
                                                                    class="regular donate-to-label">Social
                                                                    Program</label>
                                                            </div>
                                                        </div>
                                                    </label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="select">
                                                        ...
                                                        <select name="" id="" class="select__list regular"
                                                            style="height: 48px;">
                                                            <option value="" class="select__list--item">Choose Charity
                                                            </option>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div id="prevBtn">
                                                    <button type="button" class="upload__body--prev bold prev-btn-mob"
                                                        style="width: 100%;" onclick="nextPrev(-1)">Previous</button>
                                                </div>
                                            </div>
                                            <div class="col-12" style="margin-top: 16px;">
                                                <div id="nextBtn">
                                                    <button type="button" class="upload__body--next bold"
                                                        style="width: 100%;" id="nextBtnText"
                                        ...
                                        <div class="row" style="margin-top: 16px;">
                                            <div class="col-6">
                                                <button class="cart-order__body--btn cart-order__body--blue bold"
                                                    style="width: 100%; margin: 0; padding: 0">Save as draft</button>
                                            </div>
                                            <div class="col-6">
                                    ...
                                    <form class="upload__body upload-product-page desktop-tabs">
                                        <div class="upload__body--tab" data-tab="0" style="display: none;">
                                            ...
                                            <div class="col-12" style="margin-top: 48px;">
                                                <div class="cart-order__form--label">
                                                    ...
                                                    <div
                                                        ...
                                                        <button type="button" class="regular prev-categories">
                                                            <img src="img/svg/header-btn/arrow.svg" class="color-blue"
                                                                alt="">
                                                            <p class="color-blue">Back</p>
                                                        </button>
                                                        <ul class="categories-list regular">
                                            ...
                                            <div class="col-12" style="margin-top: 24px;">
                                                <div class="cart-order__form--label">
                                                    ...
                                                    <div class="product-upload__tags">
                                                        <p class="regular" style="display: none;">Choose Tags</p>
                                                        <ul class="selected-tags regular">
                                                            <li>
                                                                <p class="tag-name">Anniversary</p>
                                                                <img src="img/svg/popup-close.svg" class="remove-tag"
                                                                    alt="">
                                                            </li>
                                                            <li>
                                                                <p class="tag-name">Christmas & Winter</p>
                                        ...
                                        <div class="upload__body--tab" data-tab="1" style="display: none;">
                                            ...
                                            <button class="add-product-option bold">+ Add Other Product Option</button>
                                            <div class="product-description-container">
                                                <span class="product-description-title regular">Product Description
                                                    Eng</span>
                                                <textarea name="productDescription"
                                        ...
                                        <div class="upload__body--tab tab-start" data-tab="2" style="display: none;">
                                            <span class="cart-order__form--title regular fs-18">
                                                <img src="img/svg/red-union.svg" alt="">
                                                Default Details
                                            </span>
                                            <div class="row choose-delivery-type">
                                            ...
                                            <div class="row item-info-container">
                                                <div class="col-md-4">
                                                    <label class="cart-order__form--label mt-0">
                                                        <p class="cart-order__form--title regular item-info-title fs-18 upload-product-section-fields-title">
                                                            <img src="img/svg/red-union.svg" class="mr-3-ico" alt="">
                                                            Item Location
                                                        </p>
                                                        <select
                                                            class="select__list selects-inproduct-upload regular item-info"
                                                            name style="width: 100%; height: 44px !important;">
                                                            <option value="new">Choose Address</option>
                                                            <option value="opt1">Opt1</option>
                                                            <option value="opt2">Opt2</option>
                                                        </select>
                                                ...
                                                <div class="col-md-2" style="padding-right: 0px">
                                                    <label class="contact-page__form--label mt-0">
                                                        <p class="cart-order__form--title item-info-title regular fs-18 upload-product-section-fields-title">
                                                            <img src="img/svg/red-union.svg" alt="">
                                                            Shipping Weight (kg)
                                                        </p>
                                                        <input type="text" class="contact-page__form--input "
                                                            style="width: calc(100% - 10px); height: 48px;">
                                                    </label>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="contact-page__form--label mt-0">
                                                        <p class="cart-order__form--title item-info-title fs-18 regular upload-product-section-fields-title">
                                                            <img src="img/svg/red-union.svg" class="mr-3-ico" alt="">
                                                            Length (mm) / Width (mm) / Height (mm)
                                                        </p>
                                                        <div class="item-size-details">
                                                ...
                                                <div class="col-md-2">
                                                    <label class="contact-page__form--label mt-0">
                                                        ...
                                                        <input type="text" class="contact-page__form--input item-info"
                                                            style="width: 100%;">
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <label
                                                        class="contact-page__form--label mt-0 option-photo-container fs-18">
                                                        <p class="cart-order__form--title item-info-title regular upload-product-section-fields-title">
                                                            Option Photo
                                                        </p>
                                                        <div class="option-photo-actions">
                                                            <input type="file" name="photo" id="upload-option-photo"
                                                            ...
                                                            <label for="upload-option-photo"
                                                                class="upload-option-photo">
                                                                <img src="img/svg/upload-icon-small.svg"
                                                                    class="convert-svg" alt="upload" />
                                                            </label>
                                                            <button class="remove-option-photo-btn">
                                                                <img src="img/svg/trash.svg" class="remove-option-photo"
                                                                    alt="trash" />
                                                            </button>
                                                        </div>
                                                    </label>
                                        ...
                                        <div class="upload__body--tab" data-tab="3" style="display: none;">
                                            <div class="col-md-4">
                                                <label class="contact-page__form--label tab-start mt-0">
                                                    ...
                                                    <select name="" id="" class="select__list regular"
                                                        style="height: 48px;">
                                                        <option value="" class="select__list--item">
                                                        </option>
                                                        <option value="" class="select__list--item">erti</option>
                                                        <option value="" class="select__list--item">ori</option>
                                                    </select>
                                            ...
                                            <div class="col-md-4">
                                                <label class="contact-page__form--label">
                                                    ...
                                                    <div class="donate-to-options">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            <input type="radio" value="1" id="donate-to-social-program"
                                                                name="donate-to" class="radio-on-img">
                                                            <label for="donate-to-social-program"
                                                                class="regular donate-to-label">Social Program</label>
                                                        </div>
                                                    </div>
                                                </label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="d-flex justify-content-between">
                                                    <div id="prevBtn">
                                                        <button type="button"
                                                            class="upload__body--prev bold prev-next-pages-btn"
                                                            onclick="nextPrev(-1)">Previous</button>
                                                    </div>
                                                    <div id="nextBtn">
                                                        <button type="button"
                                                            class="upload__body--next bold prev-next-pages-btn"
                                                            id="nextBtnText" onclick="nextPrev(1)">Next</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-7">
                                                <div class="d-flex justify-content-end">
                                                    <button
                                                        class="cart-order__body--btn cart-order__body--blue bold save-as-draft-desktop">Save
                                                        as draft</button>
                                                    <button class="cart-order__form--btn bold">Cancel</button>
                                                </div>
                                            </div>
