                    ...
                    <div class="shop-detail__slider">
                        ...
                        <div class="shop-detail__mini-slider--cover upload__image--upload d-flex align-items-center justify-content-center">
                                ...
                                <div class="upload__image--btn-footer d-flex justify-content-between align-items-center">
                                    <input type="radio" name="main-img-1" value="1" class="radio-on-img">
                            ...
                            <div class="shop-detail__mini-slider--cover upload__image--upload d-flex align-items-center justify-content-center">
                                ...
                                <div class="upload__image--btn-footer d-flex justify-content-between align-items-center">
                                    <input type="radio" value="1" name="main-img-2" class="radio-on-img">
                                    <button class="products-slider__item--fav upload__image--btn-delete buttons-on-image-upload"><img src="img/svg/trash.svg" class="trash-on-image-upload" alt=""></button>
                                </div>
                            </div>
                            <div class="shop-detail__mini-slider--cover upload__image--upload d-flex align-items-center justify-content-center">
                ...
                <div class="col-lg-7">
                    <div class="shop-detail__info">
                        <ul class="page__navigation--links d-none d-lg-flex">
                            ...
                            <li class="page__navigation--link regular">
                                >
                                <a href="">Upload social program</a>
                            </li>
                        </ul>
                        <h1 class="shop-detail__info--title bold d-none d-lg-block">Upload Social program</h1>
                        <div class="row">
                            <div class="col-12">
                                <div class="upload">
                                    <form class="upload__body">
                                        <div class="upload__body--tab social-program-upload-form" style="display: block">
                                            <div class="col-md-11">
                                            ...
                                            <div class="col-md-4" style="height: fit-content !important">
                                                <div class="cart-order__form--label">
                                                    ...
                                                    <input type="date" class="cart-order__form--input regular social-program-fields" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                    <div class="cart-order__form--label">
                                                        ...
                                                        <select class="select__list regular selects-inproduct-upload selects-on-social-program-upload social-program-fields" name>
                                            ...
                                            <div class="col-md-4">
                                                <div class="cart-order__form--label">
                                                    ...
                                                    <input type="text" class="cart-order__form--input regular social-program-fields" placeholder="">
                                                </div>
                                            </div>
                                            <div class="col-md-11">
                                                <div class="cart-order__form--label">
                                            ...
                                            <div class="col-md-11">
                                                <div class="product-description-container">
                                                    <span class="product-description-title regular" style="margin-left: 0px">About Program ENG</span>
                                                    <textarea name="productDescription" class="product-description program-upload-description regular product-upload__descriptions" rows="10"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-11">
                                                <div class="product-description-container">
                                                    <span class="product-description-title regular" style="margin-left: 0px">About Program GEO</span>
                                                    <textarea name="productDescription" class="product-description program-upload-description regular product-upload__descriptions" rows="10"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="d-flex">
                                                    <div class="form-buttons-block">
                                                        <button type="button" class="bold social-program-upload-list-project-button">List Project</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="d-flex justify-content-end form-buttons-block">
                                                    <button class="cart-order__body--btn bold social-program-upload-draft-button">Save as draft</button>
                                                    <button class="cart-order__form--btn bold social-program-upload-cancel-button">Cancel</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
