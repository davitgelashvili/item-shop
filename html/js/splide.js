...
(function (global, factory) {
  ...
  function Arrows(Splide2, Components2, options) {
    ...
    function createArrow(prev2) {
      var arrow = "<button class=\"" + classes.arrow + " " + (prev2 ? classes.prev : classes.next) + "\" type=\"button\"><svg xmlns=\"" + XML_NAME_SPACE + "\" viewBox=\"0 0 " + SIZEwidth + " " + SIZEheight + "\" width=\"" + SIZEwidth + "\" height=\"" + SIZEheight + "\"><path d=\"" + (options.arrowPath || PATH) + "\" />";
